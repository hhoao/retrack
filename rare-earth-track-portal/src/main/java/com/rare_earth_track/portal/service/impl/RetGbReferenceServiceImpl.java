...
public class RetGbReferenceServiceImpl implements RetGbReferenceService {
    ...
    @Override
    public List<RetGbReference> listGbReference(PageInfo pageInfo, RetGbReference gbReference) {
        PageHelper.startPage(pageInfo.getPageNum(), pageInfo.getPageSize());
        RetGbReferenceExample gbReferenceExample = getGbReferenceExample(gbReference);
